...
public class ParameterResourceIT {
    ...
    public static Parameter createEntity(EntityManager em) {
        Parameter parameter = new Parameter().value(DEFAULT_VALUE);
        return parameter;
    }
    ...
    public static Parameter createUpdatedEntity(EntityManager em) {
        Parameter parameter = new Parameter().value(UPDATED_VALUE);
        return parameter;
    }
    ...
    public void createParameter() throws Exception {
        ...
        restParameterMockMvc
            .perform(
                post("/api/parameters").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(parameterDTO))
            )
    ...
    public void getAllParametersWithEagerRelationshipsIsEnabled() throws Exception {
        ...
        restParameterMockMvc.perform(get("/api/parameters?eagerload=true")).andExpect(status().isOk());
    ...
    public void updateParameter() throws Exception {
        ...
        updatedParameter.value(UPDATED_VALUE);
        ParameterDTO parameterDTO = parameterMapper.toDto(updatedParameter);

        restParameterMockMvc
            .perform(
                put("/api/parameters").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(parameterDTO))
            )
            .andExpect(status().isOk());
