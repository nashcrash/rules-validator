...
public class ConverterResourceIT {
    ...
    public void createConverter() throws Exception {
        ...
        restConverterMockMvc
            .perform(
                post("/api/converters").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(converterDTO))
            )
    ...
    public void getAllConverters() throws Exception {
        ...
        restConverterMockMvc
            .perform(get("/api/converters?sort=id,desc"))
    ...
    public void getConverter() throws Exception {
        ...
        // Get the converter
        restConverterMockMvc
            .perform(get("/api/converters/{id}", converter.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingConverter() throws Exception {
        // Get the converter
        restConverterMockMvc.perform(get("/api/converters/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateConverter() throws Exception {
        ...
        updatedConverter.converterCode(UPDATED_CONVERTER_CODE).description(UPDATED_DESCRIPTION).beanName(UPDATED_BEAN_NAME);
        ConverterDTO converterDTO = converterMapper.toDto(updatedConverter);

        restConverterMockMvc
            .perform(
                put("/api/converters").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(converterDTO))
            )
            .andExpect(status().isOk());
    ...
    public void deleteConverter() throws Exception {
        ...
        restConverterMockMvc
            .perform(delete("/api/converters/{id}", converter.getId()).accept(MediaType.APPLICATION_JSON))
