...
public class OperatorResourceIT {
    ...
    public void createOperator() throws Exception {
        ...
        assertThat(testOperator.getNumberOfParams()).isEqualTo(DEFAULT_NUMBER_OF_PARAMS);
    }
    ...
    public void updateOperator() throws Exception {
        ...
        assertThat(testOperator.getNumberOfParams()).isEqualTo(UPDATED_NUMBER_OF_PARAMS);
    }
