...
public class OperatorResourceIT {
    ...
    public void createOperator() throws Exception {
        ...
        restOperatorMockMvc
            .perform(post("/api/operators").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorDTO)))
    ...
    public void getAllOperators() throws Exception {
        ...
        restOperatorMockMvc
            .perform(get("/api/operators?sort=id,desc"))
    ...
    public void getOperator() throws Exception {
        ...
        // Get the operator
        restOperatorMockMvc
            .perform(get("/api/operators/{id}", operator.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingOperator() throws Exception {
        // Get the operator
        restOperatorMockMvc.perform(get("/api/operators/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateOperator() throws Exception {
        ...
        restOperatorMockMvc
            .perform(put("/api/operators").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(operatorDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteOperator() throws Exception {
        ...
        // Delete the operator
        restOperatorMockMvc
            .perform(delete("/api/operators/{id}", operator.getId()).accept(MediaType.APPLICATION_JSON))
