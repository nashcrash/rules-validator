...
describe('Service Tests', () => {
  describe('Param Service', () => {
    ...
    let elemDefault: IParam;
    let expectedResult: IParam | IParam[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Param(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Param', () => {
        ...
        service.create(new Param()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Param', () => {
        const returnedFromService = Object.assign(
          {
            value: 'BBBBBB',
          },
