...
import { ConverterComponent } from 'app/entities/converter/converter.component';
...
describe('Component Tests', () => {
  describe('Converter Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConverterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.converters && comp.converters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
