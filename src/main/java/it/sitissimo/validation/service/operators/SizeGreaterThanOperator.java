...
@Component(GenericOperator.Names.sizeGtOperator)
public class SizeGreaterThanOperator extends AbstractOperator implements GenericOperator {
    ...
    public List<RvValidationResultDetailDTO> validate(Object[] params, JsonNode jsonNode, RvRuleDTO ruleDTO) throws ValidationException {
        ...
        if (valid) {
            ...
            return makeRvValidationResultDetailDTO(Names.sizeGtOperator, params, jsonNode, ruleDTO);
        }
    }
}
