...
@Component(GenericOperator.Names.sizeLtOperator)
public class SizeLesserThanOperator extends AbstractOperator implements GenericOperator {
    ...
    public List<RvValidationResultDetailDTO> validate(Object[] params, JsonNode jsonNode, RvRuleDTO ruleDTO) throws ValidationException {
        ...
        if (valid) {
            ...
            return makeRvValidationResultDetailDTO(Names.sizeLtOperator, params, jsonNode, ruleDTO);
        }
    }
}
