...
@Component(GenericOperator.Names.isNotNullOperator)
public class IsNotNullOperator extends AbstractOperator implements GenericOperator {
    ...
    public List<RvValidationResultDetailDTO> validate(Object[] params, JsonNode jsonNode, RvRuleDTO ruleDTO) throws ValidationException {
        ...
        if (ref1 != null) {
            ...
            return makeRvValidationResultDetailDTO(GenericOperator.Names.isNotNullOperator, params, jsonNode, ruleDTO);
        }
    }
}
