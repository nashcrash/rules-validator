...
public class Converter implements Serializable {
    ...
    public Converter params(Set<Param> params) {
        this.params = params;
        return this;
    }

    public Converter addParam(Param param) {
        this.params.add(param);
        param.getConverters().add(this);
        return this;
    }

    public Converter removeParam(Param param) {
        this.params.remove(param);
        param.getConverters().remove(this);
        return this;
    }
