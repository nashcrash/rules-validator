...
export class OperatorComponent implements OnInit, OnDestroy {
  ...
  registerChangeInOperators(): void {
    this.eventSubscriber = this.eventManager.subscribe('operatorListModification', () => this.reset());
  }
  ...
  protected paginateOperators(data: IOperator[] | null, headers: HttpHeaders): void {
